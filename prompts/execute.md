...
if [ -n "${PI_SESSION_FILE:-}" ]; then
  ...
  echo "Error: PI_SESSION_FILE or CLAUDE_CODE_SESSION_ID is required for /execute; no session handover files can be derived." >&2
  exit 1
fi
